...
const generateTeam = require("./generateApp/generateTeam");
const OUTPUT_DIR = path.resolve(__dirname, "dist");
const outputPath = path.join(OUTPUT_DIR,"index.html");

const team = [];

// asks user to add employee to team
const promptMenu = () => {
  inquirer
    .prompt([
      {
        type: "list",
        message:
          "Do you want to add a team member. If yes, choose one of the options below. If no, choose 'Done'",
